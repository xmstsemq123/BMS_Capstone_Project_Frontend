...
const Block = ({ title, children, className }) => {
  return (
    <div className={`bg-[#d6d6d6] rounded-xl shadow-md p-6 text-black ${className}`}>
...
export default function Home() {
  ...
  return (<>
    <div className="p-6 bg-[#ffffff] select-none">
    ...
    <div className="p-6 bg-[#d6d6d6] mt-6 select-none">
      <h1 className="text-2xl font-bold text-black mb-6">單一元件狀態總覽</h1>
      <CellActivityBlock />
    </div>
  </>);
}
