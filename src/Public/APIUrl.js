...
const PUT_CHANGE_RELAY_STATUS = HTTP_API_URL + "/put/RelayStatus"
//------ Analytics Page URL ------//
const POST_GRATH_DATA = HTTP_API_URL + "/getData_graph"
const GET_BALANCE_AND_RELAY = HTTP_API_URL + "/get/BalanceAndRelay"
const POST_BALANCECURRENT_DATA = HTTP_API_URL + "/post/GraphData/BalanceCurrent"
//------ Annomaly Page URL ------//
...
export { 
    ...
    GET_NEWEST_MEAN_DATA, GET_CELL_ALL_DATA, PUT_CHANGE_RELAY_STATUS,
    POST_GRATH_DATA, GET_BALANCE_AND_RELAY, POST_BALANCECURRENT_DATA, 
